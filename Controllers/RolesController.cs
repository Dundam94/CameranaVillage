...
namespace CameranaVillage.Controllers
{
    public class RolesController : Controller
    {
        ...
        public IActionResult GestioneUtenti([FromServices] DBContext dBContext, string roleName)
        {
        ...
        #region roles
        [HttpPost]
        public async Task<IActionResult> CreateRole([FromServices] DBContext dBContext, string roleName)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<IActionResult> DeleteRole([FromServices] DBContext dBContext, [FromServices] UserManager<User> userManager, string roleID)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public async Task<IActionResult> AddClaimToRole([FromServices] DBContext dBContext, [FromServices] UserManager<User> userManager, string roleID, string claimType, string claimValue)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        [HttpPost]
        public async Task<IActionResult> RemoveClaimFromRole([FromServices] DBContext dBContext, [FromServices] UserManager<User> userManager, string roleID, string claimType, string claimValue)
        {
            try
            {
                if (ModelState.IsValid)
