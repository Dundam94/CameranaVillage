﻿--la password dell'utente è Password01!
...
(
	...
	IdAttivita uniqueidentifier not null,
	primary key (IdPrenotazioneAttivita),
	foreign key (IdAttivita) references Attivita(IdAttivita),
	foreign key (IdUtente) references AspNetUsers(Id)
)


INSERT INTO Attivita
SELECT NEWID(), 'Festa in barca', 'Attività estiva', '2023-07-15 10:30:00', '2023-07-20 12:00:00', 10, 42.50
INSERT INTO Attivita
SELECT NEWID(), 'Trekking', 'Attività estiva', '2023-07-18 10:30:00', '2023-07-20 12:00:00', 20, 13.70
INSERT INTO Attivita
SELECT NEWID(), 'Windsurf', 'Attività estiva', '2023-07-21 10:30:00', '2023-07-22 12:00:00', 15, 15.90
INSERT INTO Attivita
SELECT NEWID(), 'Alpinismo', 'Attività invernale', '2023-12-15 10:30:00', '2023-12-16 12:00:00', 15, 15.90
INSERT INTO Attivita
SELECT NEWID(), 'Settimana bianca', 'Attività invernale', '2023-12-20 10:30:00', '2023-12-25 12:00:00', 10, 85.00
INSERT INTO Attivita
SELECT NEWID(), 'Capodanno bianco', 'Attività invernale', '2023-12-31 21:30:00', '2024-01-01 12:00:00', 40, 15.90
